...
export default function HelpGuide({ steps, onFinish, autoOpen = false, autoOpenKey = null }) {
  ...
  return (
    <>
      {/* Préchargement invisible des sprites de l'arbitre */}
      <div style={{ position: 'absolute', width: 0, height: 0, overflow: 'hidden', visibility: 'hidden', zIndex: -1 }}>
        <img src={withBasePath('/arbitre/arbitre_gauche.png')} alt="preload" />
        <img src={withBasePath('/arbitre/arbitre_droite.png')} alt="preload" />
      </div>
